          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex justify-between items-center py-3 md:justify-start md:space-x-10">
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="/">
                  <div className="flex space-x-0.5 flex-wrap">
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                  ...
                  <div className="flex space-x-0.5 flex-wrap pt-0.5">
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border bg-purple-700 bg-purple-700"></p>
                    <p className="w-1.5 h-1.5 border bg-purple-700 bg-purple-700"></p>
                    <p className="w-1.5 h-1.5 border bg-purple-700 bg-purple-700"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                  ...
                  <div className="flex space-x-0.5 pt-0.5">
                    ...
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                    <p className="w-1.5 h-1.5 border bg-purple-700-300 bg-purple-700"></p>
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
                  </div>
                  <div className="flex space-x-0.5 pt-0.5">
                    <p className="w-1.5 h-1.5 border border-gray-200 bg-gray-100"></p>
              ...
              <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <a href="team" className="text-base font-medium text-gray-500 hover:text-purple-700">
                  😎 About Us
                </a>
                <a href="til" className="text-base font-medium text-gray-500 hover:text-purple-700">
                  🧑‍💻 Today I Learned (TIL)
                </a>
