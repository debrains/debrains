            ...
            <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                <div className="space-y-12">
                    <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Debrain Team</h2>
                        <p className="text-xl text-gray-500">
                            성장에 목마른 4명의 개발자와, 1명의 잡부로 구성된 데브레인 팀은 개인의 성장에 촛점을 맞춥니다.
                        </p>
                    </div>
                    <ul
                        role="list"
                            ...
                            <li key={person.name}>
                                <div className="space-y-4">
                                    <div className="aspect-w-3 aspect-h-2">
                                        <img className="object-cover shadow-lg rounded-lg border border-gray-300" src={person.imageUrl} alt="" />
                                    </div>
