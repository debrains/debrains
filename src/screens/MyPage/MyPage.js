    ...
    return (
        <form className="space-y-8 divide-y divide-gray-200">
            <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                <div>
                    <div>
                        <h3 className="text-lg leading-6 font-medium text-gray-900">데브레인에 오신 것을 환영합니다! ✨😎</h3>
                ...
                <textarea
                    ...
                    defaultValue={''}
                />
                                <p className="mt-2 text-sm text-gray-500">간단하게 적어주세요 :) </p>
                            </div>
                        </div>
                ...
                <div className="divide-y divide-gray-200 pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div>
                        <h3 className="text-lg leading-6 font-medium text-gray-900">이메일 수신 동의</h3>
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">
            ...
            <div className="min-h-full">
                ...
                <div className="py-10">
                    <div className="mt-8 max-w-3xl mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
                        <section aria-labelledby="timeline-title" className="lg:col-start-1 lg:col-span-01">
                            ...
                            <div className="bg-white p-5 shadow sm:rounded-lg border border-purple-200 ">
                                ...
                                <div className="">
                                    ...
                                    <div className="mb-10">
                                        ...
                                        <span className="border border-2 border-purple-600 bg-purple-600 text-white font-bold rounded-xl p-2 my-5 hover:bg-purple-100 cursor-pointer mr-2">JAVA</span>
                                        <span className="border border-2 border-purple-600 rounded-xl p-2 my-5 hover:bg-purple-100 cursor-pointer mr-2">Python</span>
                                ...
                                <div className="mt-6 flex flex-col justify-stretch">
                                    <button
                                        type="button"
                                        className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-purple-600 hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                    >
                                        프로필 수정하기
                                    </button>
                                </div>
